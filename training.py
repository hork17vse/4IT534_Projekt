...
from torchvision.models import ResNet50_Weights # Změna na ResNet50
...
# Definice modelu ResNet50
MODEL_NAME = "resnet50" # Změna názvu modelu

print(f"\nTrénování modelu: {MODEL_NAME}")
print(f"Trénuji {MODEL_NAME} s {num_classes} třídami: {labels}")

model = models.resnet50(weights=ResNet50_Weights.DEFAULT) # Změna na ResNet50

# Zmrazení a rozmrazení vrstev (stejný postup, ale funguje pro ResNet50)
...
model.fc = nn.Sequential(  # Úprava fc vrstvy pro ResNet50
    nn.Dropout(0.3),
